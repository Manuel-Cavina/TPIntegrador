    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/actuator/**", "/api/v1/solicitudes/publico/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/solicitudes/**").hasRole("OPERADOR")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/solicitudes/**").hasRole("OPERADOR")
